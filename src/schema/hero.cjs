  ...
  settings: [
    {
      ...
      label: 'Layout',
      options: [
        { value: 'full-width', label: 'Full Width Background' },
        { value: 'split', label: 'Split Layout (Image + Text)' }
      ],
      default: 'full-width'
    },
    {
    ...
    },
    {
      type: 'select',
      id: 'text_color',
      label: 'Text Color (Full Width)',
      info: 'Only applies to full-width layout',
      options: [
    ...
    },
    {
      type: 'range',
      id: 'overlay_opacity',
      label: 'Image Overlay Opacity (Full Width)',
      info: 'Darkens image for better text readability',
      min: 0,
      max: 80,
      step: 10,
      unit: '%',
