...
module.exports = {
    ...
    "settings": [
        ...
        },
        {
            ...
            "options": [
                { "value": "small", "label": "Small (Contained)" },
                { "value": "medium", "label": "Medium (Wider)" },
                { "value": "large", "label": "Large (Full Width)" },
                { "value": "hero", "label": "Hero (Full Bleed)" }
            ],
            "default": "large"
        },
        {
        ...
        },
        {
            ...
            "label": "Content Width",
            "options": [
                { "value": "narrow", "label": "Narrow (Better for reading)" },
        ...
        },
        {
            ...
            "label": "Social Sharing Section Title",
        ...
        {
            "type": "select",
            "id": "related_articles_source",
            "label": "Show Articles From",
            "options": [
                { "value": "same-tags", "label": "Same Tags" },
                { "value": "same-blog", "label": "Same Blog (Recent)" },
